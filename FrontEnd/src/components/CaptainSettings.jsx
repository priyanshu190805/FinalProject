...
const CaptainSettings = ({ captain, setCaptainDpPanel, darkMode, setDarkMode, setChangeCaptainNamePanel }) => {
  ...
  return (
    <div className={`max-w-md mx-auto py-7 px-5 w-full min-h-screen ${darkMode ? "bg-[#1b1b1b] text-white" : "bg-gray-100"} relative`}>
      ...
      <div className={`${darkMode ? "bg-[#242424] text-white" : "bg-white"} rounded-xl p-4 mb-4`}>
        <div className="flex items-start gap-4 mb-2">
          ...
          <div>
            ...
            <p className={`text-lg ${darkMode ? "text-[#757575]" : "text-gray-500"}`}>{captain?.email}</p>
          </div>
        </div>
      </div>
      ...
      <div className={`${
        ...
        <div onClick={() => setChangeCaptainNamePanel(true)} className={`flex justify-between items-center p-4 ${
          ...
          <div className="flex items-center gap-3">
            <i className={`ri-pencil-fill text-2xl ${
