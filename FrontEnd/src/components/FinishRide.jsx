...
const FinishRide = ({ setFinishRidePanel, ride, darkMode }) => {
  ...
  return (
    <div>
      ...
      <h3 className="text-2xl font-semibold mt-2 mb-6">Finish this Ride</h3>
      ...
      <div className="flex justify-between items-center w-full gap-2 flex-col">
        ...
        <button
          onClick={endRide}
          className="w-full flex items-center justify-center text-lg bg-green-600 text-white font-semibold p-3 rounded-lg active:bg-green-700"
        >
          Payment Recieved
        </button>
      </div>
