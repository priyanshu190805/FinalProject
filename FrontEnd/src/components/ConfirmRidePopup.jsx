      ...
      <div className="flex justify-between items-center w-full gap-2 flex-col">
        ...
        <form className="w-full" onSubmit={submitHandler}>
          <input
            ...
            className={`px-6 py-4 font-mono text-[19px] ${darkMode ? "bg-[#3c3c3c] placeholder:text-[#b3b3b3]" : "bg-[#eee]"} rounded-lg w-full my-10 focus:outline-none focus:ring-2 focus:ring-black`}
          />
          <button
            to="/captain-riding"
